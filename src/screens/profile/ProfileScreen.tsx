  ...
  return (
    <SafeAreaView style={{ flex: 1, marginRight: 16, marginLeft: 16 }}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.iconCross} onPress={handleSubmit(onSubmitPressed)}>
          <Text>Done</Text>
        </TouchableOpacity>
      </View>
      <KeyboardShift>
        <>
          <View style={styles.avatarBlock}>
            <TouchableOpacity onPress={() => {}}>
              <Avatar
                source={{ uri: userInfo.avatarUrl ? userInfo.avatarUrl : noAvatarUrl }}
                rounded
                size={160}
              />
              ...
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <View style={styles.datapickerTextBlock}>
                    <Text style={styles.datapickerText}>Pick the date of your birth</Text>
                  </View>
                ...
                {Platform.OS === 'ios' && (
                  <View
                    ...
                    <View style={styles.buttonsView}>
                      <TouchableOpacity
                        style={[styles.button, styles.pickerButton, { borderBottomWidth: 0.25 }]}
                        onPress={confirmIOSDate}>
                        <Text style={[styles.buttonText, { color: '#87B71F' }]}>Confirm</Text>
                      </TouchableOpacity>

                      <TouchableOpacity
                        style={[styles.button, styles.pickerButton, { borderTopWidth: 0.25 }]}
                        onPress={toggleDatepicker}>
                        <Text style={[styles.buttonText, { color: '#C2534C' }]}>Cancel</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                )}
